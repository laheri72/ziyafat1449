                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="edit_user.php?id=<?php echo $user['user_id']; ?>" class="btn btn-sm btn-primary" aria-label="Edit profile for <?php echo htmlspecialchars($user['name']); ?>" title="Edit profile for <?php echo htmlspecialchars($user['name']); ?>"><i class="fas fa-edit" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
