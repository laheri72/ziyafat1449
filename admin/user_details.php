                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit_contribution.php?id=<?php echo $transaction['id']; ?>&user_id=<?php echo $user_id; ?>" 
                                       ...
                                       aria-label="Edit Contribution <?php echo htmlspecialchars($transaction['transaction_reference']); ?>">
                                    ...
                                    <a href="delete_contribution.php?id=<?php echo $transaction['id']; ?>&user_id=<?php echo $user_id; ?>" 
                                       ...
                                       aria-label="Delete Contribution <?php echo htmlspecialchars($transaction['transaction_reference']); ?>">
