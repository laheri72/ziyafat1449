                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="edit_contribution.php?id=<?php echo $transaction['id']; ?>&user_id=<?php echo $user_id; ?>" 
                                       ...
                                       aria-label="Edit contribution of <?php echo format_currency($transaction['amount_inr'], 'INR'); ?> from <?php echo date('M d, Y', strtotime($transaction['payment_date'])); ?>">
                                    ...
                                    <a href="delete_contribution.php?id=<?php echo $transaction['id']; ?>&user_id=<?php echo $user_id; ?>" 
                                       ...
                                       aria-label="Delete contribution of <?php echo format_currency($transaction['amount_inr'], 'INR'); ?> from <?php echo date('M d, Y', strtotime($transaction['payment_date'])); ?>">
