                        ...
                        ?>
                            <tr>
                                ...
                                <td data-label="Actions">
                                    <div class="action-buttons">
                                        <a href="user_details.php?id=<?php echo $user['id']; ?>" class="btn btn-primary btn-sm" aria-label="View user details for <?php echo htmlspecialchars($user['name']); ?>" title="View user details for <?php echo htmlspecialchars($user['name']); ?>">
                                        ...
                                        <?php if ($user['id'] != $_SESSION['user_id'] && !($is_finance_coordinator && $user['role'] === 'admin')): ?>
                                            <a href="delete_user.php?id=<?php echo $user['id']; ?>" 
                                               ...
                                               aria-label="Delete user <?php echo htmlspecialchars($user['name']); ?>" title="Delete user <?php echo htmlspecialchars($user['name']); ?>">
